...
_C.MODEL = CN()
# Model type
_C.MODEL.TYPE = 'Deformba'
# Model name
_C.MODEL.NAME = 'Deformba_tiny'
...
# Deformba parameters
_C.MODEL.Deformba = CN()
_C.MODEL.Deformba.IMAGE_SIZE = 224
_C.MODEL.Deformba.IN_CHANS = 3
_C.MODEL.Deformba.DEPTHS = [2, 2, 6, 2]
_C.MODEL.Deformba.EMBED_DIM = [64,128,256,512]
_C.MODEL.Deformba.MLP_RATIO = [4,4,4,4]
_C.MODEL.Deformba.HEAD_DIM = 16
_C.MODEL.Deformba.LAYERSCALE =[False,False,False,False]
